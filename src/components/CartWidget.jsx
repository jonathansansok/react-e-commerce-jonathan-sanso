    ...
    <Link to="/cart" className="cartzoom">
      <div className="liNav shoppingTodo">
        <img
          ...
          href="index.html"
          target="_blank"
          className="shoppingCart shoppingLogok"
          src="https://icongr.am/fontawesome/shopping-cart.svg?size=40&color=7809e0"
          alt="shopping cart"
        />
        <div className="contadorUnidades" href="index.html" id="contadorId">
          {totalPasajes()}
        </div>
      </div>
    </Link>
