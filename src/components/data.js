export const data = [
	...
	{ id:2, nombre: 'Quintana Roo' , pais: 'México', imagen: 'qroo', incluye: 'Pasaje + estadia', descripcion: "7 playas con ciudades en constante movimiento.", precio: '3070', categoria: 'america', stock: '10' },
	...
	{ id:4, nombre: 'Riviera Maya' , pais: 'México', imagen: 'cancun', incluye: 'Pasaje + estadia', descripcion: "Playas tranquilas, noches largas, público variado.", precio: '5000', categoria: 'america', stock: '10' },
	{ id:5, nombre: 'Villa Angostura' , pais: 'Argentina', imagen: 'angostura', incluye: 'Pasaje + estadia', descripcion: "Los mejores cerros y montañas, traking y lagos.", precio: '3300', categoria: 'america', stock: '10' },
