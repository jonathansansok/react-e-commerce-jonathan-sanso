...
function Item({ travels }) {
  ...
  return (
    //se cargan todos los campos de cada card, a travez de su ID para cada producto que ya venian desde firestone/ItemListContainer...
    ...
    <Link to={`/item/${id}`} className="li_per contenedor-Item">
      <div className="anyTravel">
        <img className="imagen-Item" src={imagen} alt={imagen} />
      </div>
