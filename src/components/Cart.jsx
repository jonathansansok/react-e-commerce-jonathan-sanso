    ...
    <main className="cart-full">
      {purchaseID ? (
        <>
          ...
          <Link to="/" className="agregarACarrito-detail">
            {" "}
            Volver a tienda
          </Link>
        </>
              ...
              <>
                <div className="renderizada-card">
                  {cartList.map((producto) => (
                    <div className="renderizada-card-unidad" key={producto.id}>
                      <img
                        className="renderizada-foto"
                        src={producto.imagen}
                        alt=""
                      />
                        ...
                        <article className="renderizada-specs-palabras">
                          ...
                          <div className="renderizada-botonera-item-cart">
                            ...
                            <div className="renderizada-botonera-item-cart-suma-resta">
                              <button
                                className="botonera-sumaresta"
                                onClick={() =>
                                  addToCart({ id: producto.id, initial: -1 })
                                }
                                disabled={producto.initial === 1}
                              >
                                <p>-</p>
                              </button>
                              <strong className="botonera-sumaresta-numero">
                                {producto.initial}
                              </strong>
                              <button
                                className="botonera-sumaresta"
                                ...
                                disabled={producto.initial === producto.stock}
                              >
                                <p>+</p>
                              </button>
                            </div>
                            <p className="subTotal">
                              SubTotal U$D{" "}
                              <strong>
                                {Number(producto.precio) * producto.initial}
                              </strong>
                              .-
                            </p>
                          </div>
                          <button
                            className="agregarACarrito-detail"
                ...
                <section className="">
                  <article className="totales-cart">
                    <button
                      className="agregarACarrito-detail vaciar-carrito"
                      onClick={removeCart}
                    >
                      Vaciar Carrito
                    </button>
                    <p className="totales-cart-item">
                      Total Pasajes: <strong>{totalPasajes()}</strong>
                    </p>
                    <p className="totales-cart-item">
                      Total U$D <strong>{totalAPagar()}</strong>.-
                    </p>
                  </article>
                    ...
                    <div style={styles.containerShop}>
                      ...
                      <form className="FormContainer" onSubmit={onSubmit}>
                        ...
                        <TextField
                          ...
                          required
                        />
                        <button className="agregarACarrito-detail">
                          FINALIZAR COMPRA
                        </button>
                      </form>
                    </div>
              ...
              <>
                <section className="">
                  <article className="carrito-vacio">
                    <h2 className="cart-full-h vacio1">
                      Su Carrito Esta Vacio
                    </h2>
                    <Link to="/">
                      <p className="agregarACarrito-detail volver">
                        Volver a tienda
                      </p>
                    </Link>
                  </article>
